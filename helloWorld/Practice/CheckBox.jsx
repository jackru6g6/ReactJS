...
class EasyCheckBoxForm extends React.Component {
    constructor(props) {
        super(props)
        this.submitForm = this.submitForm.bind(this)
        this.changeState = this.changeState.bind(this)
        //這是待辦事項的清單，id是唯一值、listName為事項、check為是否完成
        this.state = {lists : [{id:'01', listName:'寫文章', check:false},
...
ReactDOM.render(<EasyCheckBoxForm />,document.getElementById('root'))